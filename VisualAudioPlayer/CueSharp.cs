...
namespace CueSharp
{
    ...
    public class CueSheet
    {
        ...
        private void ParseCue(string[] file)
        {
            ...
            for (int i = 0; i < file.Length; i++)
            {
                ...
                try // 
                {
                    s = s.Substring(0, file[i].IndexOf(' ')).ToUpper();
                }
                catch (Exception ex)
                {
        ...
        public override string ToString()
        {
            ...
            if (m_File.Trim() != "")
            {
                output.Append("FILE \"" + m_File + "\"" + Environment.NewLine);
            }
    ...
    public struct Track
    {
        ...
        public override string ToString()
        {
            ...
            if (m_File.Trim() != "")
            {
                output.Append(Environment.NewLine + "    FILE \"" + m_File + "\"");
            }
