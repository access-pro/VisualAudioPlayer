...
Declare Function BASS_SFX_PluginResizeMove Lib "bass_sfx.dll" (ByVal handle As Long, ByVal nLeft As Long, ByVal nTop As Long, ByVal nWidth As Long, ByVal nHeight As Long) As Long
